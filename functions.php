...
function humescores_scripts() {
	...
	wp_enqueue_style('humescores-fonts', 'https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,300i,400,400i,600,600i,700,700i');

	wp_enqueue_style( 'humescores-style', get_stylesheet_uri() );

	// if ( has_nav_menu( 'menu-1' ) ) {
	// 	wp_enqueue_script( 'humescores-priority-menu', get_theme_file_uri( '/js/priority-menu.js' ), array(), '20151215', true );
	// 	wp_enqueue_script( 'humescores-touch-navigation', get_theme_file_uri( '/js/touch-keyboard-navigation.js' ), array(), '20151215', true );
	// }
	...
	wp_localize_script('humescores-navigation', 'humescoresNavigation', $script_data);
